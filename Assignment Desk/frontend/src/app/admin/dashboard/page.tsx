...
export default function AdminDashboardPage() {
  ...
  return (
    <div>
      ...
      <p style={{ color: "var(--text-secondary)", marginBottom: "32px", fontSize: "15px" }}>Overview of system counters and registrations</p>
      ...
      <div className="grid grid-3" style={{ gap: "24px" }}>
        ...
        <div className="auth-card" style={{ maxWidth: "none", padding: "28px", background: "radial-gradient(circle at top right, rgba(99, 102, 241, 0.05), transparent 60%), var(--bg-card)" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "16px" }}>
            <h3 style={{ fontSize: "14px", fontWeight: "500", color: "var(--text-secondary)", textTransform: "uppercase", letterSpacing: "0.5px" }}>Total Teachers</h3>
          ...
          <p style={{ fontSize: "40px", fontWeight: "700", color: "var(--text-primary)", letterSpacing: "-1px" }}>{stats?.totalTeachers ?? 0}</p>
        </div>
        ...
        <div className="auth-card" style={{ maxWidth: "none", padding: "28px", background: "radial-gradient(circle at top right, rgba(16, 185, 129, 0.05), transparent 60%), var(--bg-card)" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "16px" }}>
            <h3 style={{ fontSize: "14px", fontWeight: "500", color: "var(--text-secondary)", textTransform: "uppercase", letterSpacing: "0.5px" }}>Total Students</h3>
          ...
          <p style={{ fontSize: "40px", fontWeight: "700", color: "var(--text-primary)", letterSpacing: "-1px" }}>{stats?.totalStudents ?? 0}</p>
        </div>
        ...
        <div className="auth-card" style={{ maxWidth: "none", padding: "28px", background: "radial-gradient(circle at top right, rgba(245, 158, 11, 0.05), transparent 60%), var(--bg-card)" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "16px" }}>
            <h3 style={{ fontSize: "14px", fontWeight: "500", color: "var(--text-secondary)", textTransform: "uppercase", letterSpacing: "0.5px" }}>Total Classes</h3>
          ...
          <p style={{ fontSize: "40px", fontWeight: "700", color: "var(--text-primary)", letterSpacing: "-1px" }}>{stats?.totalClasses ?? 0}</p>
        </div>

        {/* Total Subjects Card */}
        <div className="auth-card" style={{ maxWidth: "none", padding: "28px", background: "radial-gradient(circle at top right, rgba(99, 102, 241, 0.05), transparent 60%), var(--bg-card)" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "16px" }}>
            <h3 style={{ fontSize: "14px", fontWeight: "500", color: "var(--text-secondary)", textTransform: "uppercase", letterSpacing: "0.5px" }}>Total Subjects</h3>
            <div style={{ background: "rgba(99, 102, 241, 0.1)", color: "var(--primary)", padding: "10px", borderRadius: "var(--radius-sm)", display: "flex" }}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <p style={{ fontSize: "40px", fontWeight: "700", color: "var(--text-primary)", letterSpacing: "-1px" }}>{stats?.totalSubjects ?? 0}</p>
        </div>
        ...
        <div className="auth-card" style={{ maxWidth: "none", padding: "28px", background: "radial-gradient(circle at top right, rgba(16, 185, 129, 0.05), transparent 60%), var(--bg-card)" }}>
          ...
          <p style={{ fontSize: "40px", fontWeight: "700", color: "var(--text-primary)", letterSpacing: "-1px" }}>{stats?.totalAssignments ?? 0}</p>
        </div>
